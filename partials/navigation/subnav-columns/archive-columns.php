	<ul class="category-toggle">
		...
		<li class="category-toggle__button"><a href="<?php echo site_url(); ?>/category/rediscovered">Rediscovered</a></li>
		<li class="category-toggle__button_active"><a href="<?php echo site_url(); ?>/category/column-archive">Archive</a></li>
	</ul>