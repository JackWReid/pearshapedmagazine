...
<div class="section-header">
	...
	<ul class="category-toggler">
		...
		<li class="button"><a href="http://localhost:8888/directory/venues">Venues</a></li>
		<li class="button-active"><a href="http://localhost:8888/directory/promoters">Promoters</a></li>
	</ul>
</div>
